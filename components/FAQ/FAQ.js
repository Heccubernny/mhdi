export default function FAQ(){
    return(
        <div>
        <div class="my-5 max-w-7xl mx-auto px-4 sm:px-6" id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
