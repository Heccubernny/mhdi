            ...
            <section className="bg-gray-900">
                <div className="flex flex-wrap">
                    ...
                    <div className="absolute bottom-0 inset-x-0 mx-auto mb-12 max-w-xl text-center" style="z-index: 10;">
                        ...
                        <a className="inline-block py-2 px-6 leading-loose rounded-t-xl rounded-l-xl bg-white hover:bg-gray-100 transition duration-200 font-bold" href="#">Get Started</a>
                    ...
                    <div className="py-10 px-3 text-center" style="z-index: 10;">
                        <h2 className="mb-2 text-2xl text-white font-bold">So much more than a business analytics tool</h2>
                        <p className="mb-6 text-gray-50 leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque efficitur nisl sodales egestas lobortis.</p>
                        <a className="py-2 px-6 rounded-t-xl rounded-l-xl rounded-l-xl bg-white hover:bg-gray-500 text-gray-600 hover:text-white transition duration-200 font-bold" href="#">Get Started</a>
                    </div>
                    </div>
                </div>
            </section>
